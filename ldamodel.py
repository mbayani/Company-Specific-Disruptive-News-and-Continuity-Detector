...
class LDAModel():
    ...
    def train_lda_model(self):
        ...
        with open('./data/train_corpus4.pkl', 'wb') as f:
            pickle.dump(train_corpus4, f)
        with open('./data/train_id2word4.pkl', 'wb') as f:
            pickle.dump(train_id2word4, f)
        with open('./data/bigram_train4.pkl', 'wb') as f:
        ...
        self.lda_train4.save('./data/lda_train4.model')
